...
# --- LISTE DES PERSONNAGES (Utilise uniquement des URLs) ---
# Remplace les URLs ci-dessous par les liens directs de tes images hébergées
personnages = [
    ...
    {"nom": "Lucas", "img": "TON_LIEN_ICI"}, 
    {"nom": "Ethan", "img": "TON_LIEN_ICI"},
    {"nom": "Léo", "img": "TON_LIEN_ICI"},
    {"nom": "Liam", "img": "TON_LIEN_ICI"},
    {"nom": "Noah", "img": "TON_LIEN_ICI"}
]
