...
def force_image_url(url):
    ...
    # Si l'URL est vide ou invalide, on retourne une image de secours neutre
    ...
    # On laisse intactes les URLs Supabase, GitHub ou localhost
    ...
    # Sécurité pour les liens externes pour forcer un rendu stable sans passer par des proxys destructeurs
    return clean_url
